...
public class SelectQuery {
	...
	public static void main(String[] args) {
		...
		try {
			...
			ResultSet resultSet = stmt.executeQuery("select * from employees where emp_no = " + 1000);
			...
			while (resultSet.next())
				System.out.println(resultSet.getInt("emp_no") + "\t | " + resultSet.getString("emp_name") + "\t | "
						+ resultSet.getFloat("salary") + "\t | " + resultSet.getString("ph_no") + "\t | " + resultSet.getString("email_id"));
